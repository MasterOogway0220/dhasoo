...
window.D = {
  ...
  registrations: [
    // Show 1 — Bollywood Retro Beats
    { id: 'DH-10201', showId: 1, name: 'Rahul Desai',    mobile: '+91 98200 11100', city: 'Andheri',    age: 31, gender: 'Male',   regDate: '10 Oct, 09:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-blue',   initials: 'RD' },
    { id: 'DH-10202', showId: 1, name: 'Sneha Patil',    mobile: '+91 70451 22200', city: 'Borivali',   age: 26, gender: 'Female', regDate: '10 Oct, 10:30 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-pink',   initials: 'SP' },
    { id: 'DH-10203', showId: 1, name: 'Manish Gupta',   mobile: '+91 91870 33300', city: 'Thane',      age: 34, gender: 'Male',   regDate: '11 Oct, 11:00 AM', callStatus: 'no_answer',  ticket: 'not_sent', checkin: 'pending',    avatar: 'av-green',  initials: 'MG' },
    { id: 'DH-10204', showId: 1, name: 'Pooja Mehta',    mobile: '+91 88795 44400', city: 'Bandra',     age: 23, gender: 'Female', regDate: '11 Oct, 02:00 PM', callStatus: 'callback',   ticket: 'not_sent', checkin: 'pending',    avatar: 'av-purple', initials: 'PM' },
    { id: 'DH-10205', showId: 1, name: 'Karan Shah',     mobile: '+91 77654 55500', city: 'Mumbai',     age: 28, gender: 'Male',   regDate: '12 Oct, 09:30 AM', callStatus: 'not_called', ticket: 'not_sent', checkin: 'pending',    avatar: 'av-indigo', initials: 'KS' },
    // Show 2 — Sufi Night with Nizami
    { id: 'DH-10211', showId: 2, name: 'Farhan Qureshi',  mobile: '+91 93456 66600', city: 'Bandra',     age: 38, gender: 'Male',   regDate: '08 Oct, 10:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-teal',   initials: 'FQ' },
    { id: 'DH-10212', showId: 2, name: 'Zara Khan',       mobile: '+91 82345 77700', city: 'Andheri',    age: 27, gender: 'Female', regDate: '08 Oct, 12:00 PM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-orange', initials: 'ZK' },
    { id: 'DH-10213', showId: 2, name: 'Imran Sheikh',    mobile: '+91 76543 88800', city: 'Thane',      age: 32, gender: 'Male',   regDate: '09 Oct, 03:00 PM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-red',    initials: 'IS' },
    { id: 'DH-10214', showId: 2, name: 'Nadia Shaikh',    mobile: '+91 87654 99900', city: 'Navi Mumbai',age: 25, gender: 'Female', regDate: '09 Oct, 05:00 PM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-blue',   initials: 'NS' },
    { id: 'DH-10215', showId: 2, name: 'Omar Ansari',     mobile: '+91 98001 10010', city: 'Mumbai',     age: 41, gender: 'Male',   regDate: '10 Oct, 08:00 AM', callStatus: 'declined',   ticket: 'not_sent', checkin: 'na',         avatar: 'av-green',  initials: 'OA' },
    // Show 3 — The Great Indian Comedy
    { id: 'DH-10221', showId: 3, name: 'Ritesh Joshi',    mobile: '+91 99887 21100', city: 'Andheri',    age: 29, gender: 'Male',   regDate: '14 Oct, 11:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-indigo', initials: 'RJ' },
    { id: 'DH-10222', showId: 3, name: 'Pallavi More',    mobile: '+91 90123 32200', city: 'Borivali',   age: 24, gender: 'Female', regDate: '14 Oct, 01:30 PM', callStatus: 'not_called', ticket: 'not_sent', checkin: 'pending',    avatar: 'av-pink',   initials: 'PM' },
    { id: 'DH-10223', showId: 3, name: 'Suresh Wagh',     mobile: '+91 88001 43300', city: 'Dadar',      age: 36, gender: 'Male',   regDate: '15 Oct, 09:00 AM', callStatus: 'no_answer',  ticket: 'not_sent', checkin: 'pending',    avatar: 'av-teal',   initials: 'SW' },
    // Show 4 — Neon Echoes Live
    ...
    { id: 'DH-10233', showId: 4, name: 'Rohan Kapoor',    mobile: '+91 91870 98765', city: 'Andheri',    age: 32, gender: 'Male',   regDate: '12 Oct, 02:15 PM', callStatus: 'no_answer',  ticket: 'sent',     checkin: 'checked_in', avatar: 'av-green',  initials: 'RK' },
    ...
    { id: 'DH-10236', showId: 4, name: 'Vikram Singh',    mobile: '+91 98001 11222', city: 'Bandra',     age: 35, gender: 'Male',   regDate: '14 Oct, 08:45 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-teal',   initials: 'VS' },
    ...
    { id: 'DH-10239', showId: 4, name: 'Divya Pillai',    mobile: '+91 76543 21098', city: 'Andheri',    age: 28, gender: 'Female', regDate: '15 Oct, 09:30 AM', callStatus: 'not_called', ticket: 'not_sent', checkin: 'pending',    avatar: 'av-blue',   initials: 'DP' },
    ...
    // Show 5 — MH Weekender Finals
    { id: 'DH-10251', showId: 5, name: 'Deepak Rane',      mobile: '+91 99001 51100', city: 'Mumbai',     age: 33, gender: 'Male',   regDate: '01 Nov, 10:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-indigo', initials: 'DR' },
    { id: 'DH-10252', showId: 5, name: 'Swati Kulkarni',   mobile: '+91 88002 52200', city: 'Thane',      age: 27, gender: 'Female', regDate: '01 Nov, 11:30 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-purple', initials: 'SK' },
    { id: 'DH-10253', showId: 5, name: 'Nikhil Pawar',     mobile: '+91 77003 53300', city: 'Navi Mumbai',age: 30, gender: 'Male',   regDate: '02 Nov, 09:00 AM', callStatus: 'no_answer',  ticket: 'not_sent', checkin: 'pending',    avatar: 'av-teal',   initials: 'NP' },
    { id: 'DH-10254', showId: 5, name: 'Aarti Shinde',     mobile: '+91 66004 54400', city: 'Borivali',   age: 25, gender: 'Female', regDate: '02 Nov, 02:00 PM', callStatus: 'callback',   ticket: 'not_sent', checkin: 'pending',    avatar: 'av-orange', initials: 'AS' },
    { id: 'DH-10255', showId: 5, name: 'Rajan Tiwari',     mobile: '+91 55005 55500', city: 'Dadar',      age: 37, gender: 'Male',   regDate: '03 Nov, 10:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'pending',    avatar: 'av-red',    initials: 'RT' },
    // Show 6 — Laugh Riot Vol 3 (completed — checked-in records)
    { id: 'DH-10261', showId: 6, name: 'Gaurav Naik',      mobile: '+91 98765 61100', city: 'Andheri',    age: 28, gender: 'Male',   regDate: '01 Oct, 09:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'checked_in', avatar: 'av-green',  initials: 'GN' },
    { id: 'DH-10262', showId: 6, name: 'Anjali Shetty',    mobile: '+91 87654 62200', city: 'Bandra',     age: 24, gender: 'Female', regDate: '01 Oct, 10:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'checked_in', avatar: 'av-pink',   initials: 'AS' },
    { id: 'DH-10263', showId: 6, name: 'Tushar More',      mobile: '+91 76543 63300', city: 'Thane',      age: 31, gender: 'Male',   regDate: '02 Oct, 11:00 AM', callStatus: 'confirmed',  ticket: 'sent',     checkin: 'no_show',    avatar: 'av-red',    initials: 'TM' },
  ],
